...
class PluginLooztickProfile extends CommonDBTM {
	...
	static function canCreate() {
		if (isset($_SESSION["profile"])) return ($_SESSION["profile"]['looztick'] == 'w');
		return false;
	}
	...
	static function canView() {
		if (isset($_SESSION["profile"])) return ($_SESSION["profile"]['looztick'] == 'w' || $_SESSION["profile"]['looztick'] == 'r');
		return false;
	}
